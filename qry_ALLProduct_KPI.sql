...
(Credit_Limit>=160000),'>160k') AS Credit_Limit_New_Range, 
  
  
Switch(
(AGE<=26 And Income_Range='30,000 up'),'FJ&Inc>=30k',
(AGE<=26 And Income_Range<>'30,000 up'),'First Jobber',
(AGE>26 And Income_Range='30,000 up'),'Inc>=30k',True,'Mass') AS CC_Segment, 
...
FROM (qry_ALLProduct_step_1 LEFT JOIN Occupation_Code_Frontend ON qry_ALLProduct_step_1.Occupation_Code=Occupation_Code_Frontend.Code) LEFT JOIN Region_KTC ON LEFT(qry_ALLProduct_step_1.ZipCode,2) =
Region_KTC.Left2_Zipcode;
